...
$ele .= '<br><input type="hidden" name="item_id['.($mm-1).']" id="item_id' .$mm. '" value="'.$mp3i.'" />Title:&nbsp;&nbsp;&nbsp;<input type="text" name="_title[]" id="title' .$mm. '" value="'.$mp3t.'" placeholder="title" /><br/>Artist:&nbsp;<input type="text" name="_artist[]"	id="artist' .$mm. '" value="'.$mp3a.'" placeholder="artist" /><br/>Song:&nbsp;&nbsp;<input type="text" size="30" name="_song[]"	id="song' .$mm. '" value="'.$mp3s.'" placeholder="song link" /><br/>Image:&nbsp;<input type="text" size="30" name="_artwork[]"	id="artwork' .$mm. '" value="'.$mp3p.'" placeholder="image link" />';

$ele .= '&nbsp;&nbsp;<a title="Add More" href="javascript:void(0)" onclick="return addNewElement()">+ Add More</a>&nbsp;&nbsp;<a title="Remove This" href="javascript:void(0)" onclick="return removeThisElement(' .$mm. ')">Remove This</a><br /><br />';  
