...
{
	var idno = parseInt( jQuery('#more_element_area').children().length + 1 );
	...
	var generatedContent = '<br><input type="hidden" name="_item_id[' + (idno-1) + ']" id="item_id' + idno + '" value="" />Title:&nbsp;&nbsp;&nbsp; <input type="text" name="_title[]"	id="title' + idno + '" value="" size="30" placeholder="title" />&nbsp;<br>Artist:&nbsp; <input type="text" name="_artist[]"	id="artist' + idno + '" value="" size="30" placeholder="artist" />&nbsp;<br>Song:&nbsp;&nbsp; <input type="text" size="30" name="_song[]"	id="song' + idno + '" value="" placeholder="media" />&nbsp;<br>Image: <input type="text" size="30" name="_artwork[]"	id="artwork' + idno + '" value="" placeholder="artwork" />&nbsp;<a href="javascript:void(0)" onclick="return removeThisElement(' + idno + ')">Remove This</a><br><br>';
